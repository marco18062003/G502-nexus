...
<head>
    ...
    <style>
        ...
        .btn-scan-trigger:hover { background: #e2e8f0; }

        .tipo-select { border: none; background: transparent; padding: 10px; cursor: pointer; }
        ...
        .btn-add { width: 100%; background: #e2e8f0; border: none; padding: 12px; border-radius: 8px; cursor: pointer; margin-top: 10px; font-weight: bold; color: #475569; }
...
function startScanner(button) {
    // Buscamos el input de la misma celda
    ...
    html5QrCode.start(
        ...
        (decodedText) => {
            ...
            // Disparar evento para que el Live Search reconozca el cambio
            activeInput.dispatchEvent(new Event('input', { bubbles: true }));
            stopScanner();
            
            // Sonido opcional o vibración
